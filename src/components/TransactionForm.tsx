    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <ModalContent>
        <form onSubmit={handleSubmit}>
          <ModalHeader>{editTransaction ? 'Editar Transação' : 'Nova Transação'}</ModalHeader>
          <ModalBody>
            <div className="space-y-4">
              ...
              <Select
                ...
                required
              >
                <SelectItem key="income" value="income">Receita</SelectItem>
                <SelectItem key="expense" value="expense">Despesa</SelectItem>
              </Select>
              <Select
                label="Categoria"
              ...
              <Select
                ...
                onChange={(e) => setFormData({ ...formData, status: e.target.value as 'paid' | 'pending' | 'scheduled' })}
                required
              >
                <SelectItem key="paid" value="paid">Pago</SelectItem>
                <SelectItem key="pending" value="pending">Pendente</SelectItem>
                <SelectItem key="scheduled" value="scheduled">Agendado</SelectItem>
              </Select>
              <Input
                type="date"
                label="Data"
